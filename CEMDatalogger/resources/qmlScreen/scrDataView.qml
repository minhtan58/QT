...
Item {
    ...
    QViewWidget {
        ...
        onViewClicked: {
            UIBridge.hmiEvent(this.objectName, CEMSEnum.HMI_DATAVIEW_SWITCH_UNIT, 1 - modeViewCO)
        }
    }
    ...
    QViewWidget {
        ...
        onViewClicked: {
            UIBridge.hmiEvent(this.objectName, CEMSEnum.HMI_DATAVIEW_SWITCH_UNIT, 1 - modeViewNO)
        }
    }
    ...
    QViewWidget {
        ...
        onViewClicked: {
            UIBridge.hmiEvent(this.objectName, CEMSEnum.HMI_DATAVIEW_SWITCH_UNIT, 1 - modeViewNOX)
        }
    }
    ...
    QViewWidget {
        ...
        onViewClicked: {
            UIBridge.hmiEvent(this.objectName, CEMSEnum.HMI_DATAVIEW_SWITCH_UNIT, 1 - modeViewSO2)
        }
    }
...
//        }
//        onViewPressAndHold: UIBridge.hmiEvent(this.objectName, CEMSEnum.HMI_DATAVIEW_SWITCH_UNIT, 1 - modeViewSO2)
    }
}
