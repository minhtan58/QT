...
//                    color: index == current ? "steelblue" : "black"
                    ...
                    gradient: Gradient {
                        GradientStop { position: 0.0; color: index == current ? "#6a9bc3" : "#000000" }
                        GradientStop { position: 0.4; color: "#1c3448" }
                        GradientStop { position: 0.6; color: "#1c3448" }
                        GradientStop { position: 1.0; color: index == current ? "#6a9bc3" : "#000000" }
                    }
                }
                ...
                QText {
                    ...
                    color: stack.children[index].enabled ? "#ffffff" : "#808080"
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        if(stack.children[index].enabled)
