...
Item {
    ...
    Item {
        ...
        Item {
                    ...
                    delegate: Item {
                        ...
                        QCheckbox {
                            ...
                            onClicked: {
                                ...
                                Delivery.hmiEvent(this.objectName, CEMSEnum.HMI_COMBOBOX_SETTINGS_ALARM, index + "," + (1 - airAlarmTurnOn))
                            }
                        }
                        MouseArea {
                            anchors.fill: parent
            ...
            QButton {
                ...
                height: 40
                text: "Save"
                eventID: CEMSEnum.HMI_BUTTON_SAVE_SETTINGS_ALARM
    ...
    Component.onCompleted: {
        listAlarm.append({airComponent: "O\u2082",  airAlarmMin: air_min_O2,        airAlarmMax: air_max_O2,        airUnit:"%V",           airAlarmTurnOn: air_status_O2       })
        listAlarm.append({airComponent: "CO",       airAlarmMin: air_min_CO,        airAlarmMax: air_max_CO,        airUnit:"mg/Nm\u00B3",  airAlarmTurnOn: air_status_CO       })
        listAlarm.append({airComponent: "NO",       airAlarmMin: air_min_NO,        airAlarmMax: air_max_NO,        airUnit:"mg/Nm\u00B3",  airAlarmTurnOn: air_status_NO       })
        listAlarm.append({airComponent: "NOx",      airAlarmMin: air_min_NOX,       airAlarmMax: air_max_NOX,       airUnit:"mg/Nm\u00B3",  airAlarmTurnOn: air_status_NOX      })
        listAlarm.append({airComponent: "SO\u2082", airAlarmMin: air_min_SO2,       airAlarmMax: air_max_SO2,       airUnit:"mg/Nm\u00B3",  airAlarmTurnOn: air_status_SO2      })
        listAlarm.append({airComponent: "Temperature",     airAlarmMin: air_min_TEMP,      airAlarmMax: air_max_TEMP,      airUnit:"\u00B0C",      airAlarmTurnOn: air_status_TEMP     })
        listAlarm.append({airComponent: "Oppacity", airAlarmMin: air_min_OPP,       airAlarmMax: air_max_OPP,       airUnit:"%",            airAlarmTurnOn: air_status_OPP      })
        listAlarm.append({airComponent: "Dust PM",  airAlarmMin: air_min_DUST_PM,   airAlarmMax: air_max_DUST_PM,   airUnit:"mg/Nm\u00B3",  airAlarmTurnOn: air_status_DUST_PM  })
        listAlarm.append({airComponent: "Velocity", airAlarmMin: air_min_VEL,       airAlarmMax: air_max_VEL,       airUnit:"m/s",          airAlarmTurnOn: air_status_VEL      })
        listAlarm.append({airComponent: "Flow",     airAlarmMin: air_min_FLOW,      airAlarmMax: air_max_FLOW,      airUnit:"m\u00B3/s",    airAlarmTurnOn: air_status_FLOW     })
    }
