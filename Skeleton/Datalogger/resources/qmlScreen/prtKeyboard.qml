...
Item {
    ...
    Item {
        ...
        QKeyWidget {
            ...
            onKeyCtrlClicked: {
                Delivery.keyboardEvent(1, "shift_clicked")
            }
            onKeyCtrlPressAndHold: {
                Delivery.keyboardEvent(1, "shift_hold")
            }
        }
        QKeyWidget {
            id: ui_z_caps
        ...
        QKeyWidget {
            ...
            onKeyCtrlClicked: {
                Delivery.keyboardEvent(1, "delete_clicked")
            }
            onKeyCtrlPressAndHold: {
                Delivery.keyboardEvent(1, "delete_hold")
            }
        }
        QKeyWidget {
            id: ui_qn123
