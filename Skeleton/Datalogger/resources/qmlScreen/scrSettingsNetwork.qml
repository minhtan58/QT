        ...
        QTabWidget {
                ...
                QSpinBox {
                    ...
                    onSpinClicked: {
                        if(currentValue >= minValue && currentValue <= maxValue)
                            Delivery.hmiEvent(this.objectName, CEMSEnum.HMI_SPINBOX_CHANGE_SERVER_INTERVAL, (Number(currentValue) * 60000))
                    }
                }
            ...
            Item {
                ...
                QSpinBox {
                    ...
                    onSpinClicked: {
                        if(currentValue >= minValue && currentValue <= maxValue)
                            Delivery.hmiEvent(this.objectName, CEMSEnum.HMI_SPINBOX_CHANGE_FTP_INTERVAL, (Number(currentValue) * 60000))
                    }
                }
