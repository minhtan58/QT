...
void HistoryDataListFeeder::run() {
    ...
    QString searchTime = GETDPDATA(CEMSEnum::DP_SEARCH_TIME_HISTORY_DATA);
    //DLOG("searchTime = %s", searchTime.toStdString().data());
    ...
    QList<CemsDataRow> list = DataManager::getInstance()->getHistoryDataList();
