...
#define STORAGE_FOLDER  "/usr/KD201E/saved/"
#elif _WIN32
#define TEMP_FOLDER     "D://KD201E/temp/"
#define STORAGE_FOLDER  "D://KD201E/saved/"
#else
#define TEMP_FOLDER     ""
#endif
...
private:
    ...
    QUrl *m_ftpUrl = nullptr;
    QFile *m_fileWrite = nullptr;
    QFile *m_fileFtp = nullptr;
    QDir *m_dir = nullptr;
    QTextStream *m_writeStream = nullptr;
    QTimer *m_timerScanUnsendFile = nullptr;
    QTimer *m_timerScanStorageFile = nullptr;

public:
    explicit KD201E(QObject *parent = nullptr);

    QString getDataString();                                            //get html parsed as qstring
    ...
    bool saveToStorageFolder(QString fileName);                           //save to saved folder
...
public slots:
    ...
    void slt_updateStorageListFile();
